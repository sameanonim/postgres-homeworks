...
ALTER TABLE products ADD CONSTRAINT valid_discontinued CHECK (discontinued IN (0, 1))
...
-- FOREIGN KEY (product_id) REFERENCES products(product_id) ON DELETE CASCAD